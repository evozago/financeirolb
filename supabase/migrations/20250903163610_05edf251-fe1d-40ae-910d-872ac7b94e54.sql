...
-- Drop old tables (keep them for now as backup)
-- DROP TABLE IF EXISTS funcionarios CASCADE;
-- DROP TABLE IF EXISTS vendedoras CASCADE;  
-- DROP TABLE IF EXISTS fornecedores CASCADE;

-- Create compatibility views
CREATE OR REPLACE VIEW public.funcionarios_view AS
SELECT 
...
CREATE OR REPLACE VIEW public.fornecedores_view AS
SELECT 

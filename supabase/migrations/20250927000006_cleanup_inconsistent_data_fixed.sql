-- Limpeza de dados inconsistentes e otimização do sistema de pessoas e papéis (CORRIGIDA)
-- Data: 2025-09-27
...
-- 2. Função para sincronizar categorias em pessoas baseado nos papéis ativos (CORRIGIDA)
